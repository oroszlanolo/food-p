...
export class FormHelper {
  ...
  getDirectionsFromSection(section: AbstractControl<unknown, unknown>) {
    return section.get('directions') as FormArray;
  }

  getSection(sectionName: string): AbstractControl<unknown, unknown> | null {
  ...
  updateRecipeForm() {
    if (this.recipe) {
      ...
      if (this.recipe.preparationTime.preparation) {
        this.form.get('preparationTime')?.get('preparation')?.setValue(this.recipe.preparationTime.preparation);
      }
      if (this.recipe.preparationTime.owen) {
        this.form.get('preparationTime')?.get('owen')?.setValue(this.recipe.preparationTime.owen);
      }
      if (this.recipe.preparationTime.cooking) {
        this.form.get('preparationTime')?.get('cooking')?.setValue(this.recipe.preparationTime.cooking);
      }
      if (this.recipe.preparationTime.total) {
        this.form.get('preparationTime')?.get('total')?.setValue(this.recipe.preparationTime.total);
      }

import { Component, computed, DestroyRef, forwardRef, inject, input, model, signal } from '@angular/core';
...
export class InputCompleteComponent {
  ...
  valueChanged($event: Event) {
    this.filteredValueOptions.set(this.valueOptions.filter(
      u => u.toLowerCase().includes(($event.target as HTMLInputElement).value.toLowerCase())));
